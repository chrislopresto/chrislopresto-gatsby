      ...
      <div className="p-3 md:p-5 bg-alt text-primary font-mono">
        ...
        <section className="mb-10 max-w-3xl">
          ...
          <p className="mb-2">
            ...
            <sup className="text-xs">**</sup> around the world<sup className="text-xs">***</sup>, most notably with Roc
            Nation / Epic Records recording artist Hugo. Chris has performed on Late Night with David Letterman, Jimmy
            Kimmel Live!, X Factor, and morning shows that film far too early.
          </p>
          <p className="mb-2">
            More miscellaneously, Chris is an Eagle Scout who has visited 46 of the 50 states and ridden a private
            elevator with a pope<sup className="text-xs">****</sup>. He lives in New York City with his wife, Louise,
            and his dog, Roland, and is always game to debate which is better, cake or pie
